...
def _cron_minutes(workflow, expand=None):
    ...
    THE EXPANSION IS NOT DEFINED HERE (#1279) — `cron_map.cron_minutes` owns it, handles
...
def _test_cron_minute_expansion(chk):
    ...
    chk("cron: the expansion is OWNED by cron_map.py, and a checkout without it RAISES "
